  ...
  <div class="resume-list-page">
    <div class="page-header">
      ...
      <div class="header-content">
        ...
        <p class="page-subtitle">查看、搜索和管理所有候选人简历</p>
      </div>
      <div class="header-actions">
        <el-button type="primary" size="large" class="action-btn" @click="router.push('/resumes/upload')">
    ...
    <div class="page-content">
      <div class="search-card glass-card">
        <el-form :inline="true" :model="searchForm" class="search-form">
          ...
          <el-form-item>
            <el-button type="primary" class="search-btn" @click="fetchResumes">搜索</el-button>
        ...
        >
          ...
          <el-table-column label="操作" width="280">
            <template #default="{ row }">
              ...
              <el-button size="small" type="primary" class="action-btn-small" @click="router.push(`/resumes/parse/${row.id}`)">解析结果</el-button>
              <el-button v-if="row.status === 'failed'" size="small" type="warning" class="action-btn-small" @click="handleReupload(row)">重新上传</el-button>
...
const handleReupload = (row) => {
  ElMessageBox.confirm('确定要重新上传该简历吗?', '提示', {
    confirmButtonText: '确定',
    cancelButtonText: '取消',
    type: 'warning'
  }).then(() => {
    router.push(`/resumes/upload?reupload=${row.id}`)
  })
}
